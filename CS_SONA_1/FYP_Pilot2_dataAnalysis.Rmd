...
n.obs=854,plot=TRUE,title="Very Simple Structure",use="pairwise",cor="cor")
```
...
### drop items
drop appoach_avoidance_R & attainment_maintainance_R
```{r}
...
```{r}
# use Very Simple Structure criterion
psych::nfactors(corrM_new, n = 10, rotate = "promax", diagonal = FALSE, fm = "minres", 
n.obs=854,plot=TRUE,title="Very Simple Structure",use="pairwise",cor="cor")
```
...
```{r}
# extract 5 factors
fa_raw_5 <-fa(r=corrM_new, nfactors=5,n.obs = 854, rotate="promax", SMC=FALSE, fm="minres")
#fa.sort(fa_raw_5)

# extract 6 factors
fa_raw_6 <-fa(r=corrM_new, nfactors=6,n.obs = 854, rotate="promax", SMC=FALSE, fm="minres")

# extract 7 factors
fa_raw_7 <-fa(r=corrM_new, nfactors=7,n.obs = 854, rotate="promax", SMC=FALSE, fm="minres")
#fa.sort(fa_raw_7)
```
...
goalLevelDf <- cbind(select(factorScoreDf, "goal_order" : "External_factor"), goalDf_wide[,c("advancement", "commitment", "effort", "urgency", "initial_time_R")])
